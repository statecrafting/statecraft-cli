...
| `docs/decisions/**` | authored, claimed by spec `001` | Editing it is a change to spec `001`'s territory. The design record that was `docs/design/` is now spec `001` sections 3.8 to 3.12. |
