...
.tooling/bin/spec-spine --version         # must satisfy the =0.25.0 pin
...
**Exit 2 means stale, and only stale, under the pin** (0.20.0, 0.23.0 since
2026-09-23, and 0.25.0 since 2026-09-24). A claim that
...
0.23.0 on 2026-09-23 and under 0.25.0 on 2026-09-24. Under the previous 0.18.0 pin both conditions exited 2 and
...
Under 0.23.0 and 0.25.0 each `plan --json` ready row also carries `status` (spec-spine's
