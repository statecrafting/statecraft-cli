...
| `docs/decisions/**` | authored, claimed by spec `001` | Editing it is a change to spec `001`'s territory. The founding design record that lived at `docs/design/00-...` is now spec `001` sections 3.8 to 3.12. |
| `docs/design/**` | authored, claimed by the spec it informs | A dated design or handoff record, claimed by a `Spec:` comment in its own first line. `01-spec-spine-harness-handoff-2026-09.md` is spec `002`'s, as input to its section 3.14. |
