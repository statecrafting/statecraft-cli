---
name: statecraft-commit
description: "Create a git commit with an impact-focused conventional commit message whose scope is the spec ordinal (feat(017): ...), with the regenerated derived shards staged alongside the change they describe. Applies only inside a Statecraft project: a repository holding `.statecraft/environment.json`. Outside one, ignore this file entirely."
allowed-tools: Bash
